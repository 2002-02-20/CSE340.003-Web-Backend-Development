...
fav_account integer NOT NULL,
fav_inventory integer NOT NULL,
  CONSTRAINT favorites_pkey PRIMARY KEY (fav_id),
  CONSTRAINT fk_account FOREIGN KEY (fav_account)
REFERENCES public.account (account_id),
CONSTRAINT fk_inventory FOREIGN KEY (fav_inventory)
REFERENCES public.inventory (inv_id),
UNIQUE (fav_account, fav_inventory)
);
